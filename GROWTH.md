...
**How to run it this month:** `NETWORK.md` — seed a small player network, sit Classic hour (20:00 UTC), use the rake invite. Live product is v1.3.26. This file is the constraints.
...
Do not build more product for growth. Run `NETWORK.md`. v1.3.26 is live. Sit Classic, pay the first cash-out, open one Telegram, send invite links to people you already know.
